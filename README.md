...
- [**@nestjsx/crud-prisma**](packages/crud-prisma/README.md) - Prisma package which provides `PrismaCrudService` with explicit model metadata so existing `@Crud()` controllers can keep their routes and request parsing ([docs](https://github.com/nestjsx/crud/wiki/ServicePrisma))
...
- :rocket: [CRUD Prisma Service](https://github.com/nestjsx/crud/wiki/ServicePrisma#description)
